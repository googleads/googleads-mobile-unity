...
void GADUMFyberSetGDPRConsent(bool consent) { [IASDKCore.sharedInstance setGDPRConsent:consent]; }

void GADUMFyberSetGDPRConsentString(const char *_Nonnull consentString) {
