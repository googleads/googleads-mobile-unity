...
namespace GoogleMobileAds.iOS.Mediation.VerizonMedia
{
    ...
    internal class Externs
    {
        ...
        [DllImport("__Internal")]
        internal static extern IntPtr GADUMVerizonMediaCreateMutableDictionary();

        [DllImport("__Internal")]
        internal static extern void GADUMVerizonMediaDictionaryAddObject(IntPtr dictionary, string key, string value);
    }
}
