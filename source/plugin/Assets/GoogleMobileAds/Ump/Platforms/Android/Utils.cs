...
namespace GoogleMobileAds.Ump.Android
{
            ...
            ConsentRequestParameters consentRequestParameters, AndroidJavaObject activity)
    {
        ...
        {
            // Mock the java object for testing purposes.
            return new AndroidJavaObject("dummyConsentRequestParameters");
        }
        ...
        consentRequestParametersBuilder = consentRequestParametersBuilder.Call<AndroidJavaObject>(
                "setTagForUnderAgeOfConsent", consentRequestParameters.TagForUnderAgeOfConsent);

        // Build ConsentDebugSettings object
        ConsentDebugSettings consentDebugSettings = consentRequestParameters.ConsentDebugSettings;
        AndroidJavaObject consentDebugSettingsBuilder =
                new AndroidJavaObject(Utils.ConsentDebugSettingsBuilderClassName, activity);

        consentDebugSettingsBuilder = consentDebugSettingsBuilder.Call<AndroidJavaObject>(
                "setDebugGeography", (int)consentDebugSettings.TestDebugGeography);
        ...
        return consentRequestParametersBuilder.Call<AndroidJavaObject>("build");
    }
