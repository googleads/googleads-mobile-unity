...
namespace GoogleMobileAds.Ump.Common
{
    ...
    public interface IConsentInformationClient
    {
        ...
        /// <summary>
        /// <param name="consentRequestParameters">The request params.</param>
        /// <param name="successListener">The consent request success listener.</param>
        /// <param name="failureListener">The consent request failure listener.</param>
        void RequestConsentInfoUpdate(ConsentRequestParameters consentRequestParameters,
        ...
        /// <summary>
        /// Returns <c>true</c> if a ConsentForm is available, <c>false</c> otherwise.
        /// </summary>
