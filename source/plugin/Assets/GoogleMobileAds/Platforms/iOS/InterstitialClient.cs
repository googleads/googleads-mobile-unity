...
#region full screen content callback types
    ...
    internal delegate void GADUInterstitialAdDidPresentFullScreenContentCallback(
    ...
    private IntPtr InterstitialPtr {
      get { return this.interstitialPtr; }
...
#region interstitial ad callback methods
    ...
    private static void InterstitialPaidEventCallback(IntPtr interstitialClient, int precision,
    ...
    private static void AdFailedToPresentFullScreenContentCallback(IntPtr interstitialClient,
                                                                   IntPtr error) {
      InterstitialClient client = IntPtrToInterstitialClient(interstitialClient);
