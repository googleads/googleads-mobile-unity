...
namespace GoogleMobileAds.iOS
{
        ...
        IPictureInPictureAdClient, IDisposable
    {
        ...
        public PictureInPictureAdClient()
        {
            CreatePictureInPictureAd();
        }
        ...
        {
            if (this.PictureInPictureAdPtr != IntPtr.Zero)
            {
                return;
            }
            ...
            Externs.GADUSetPictureInPictureAdCallbacks(
                ...
                PictureInPictureAdDidFailToShowCallback,
        ...
        public void Destroy()
        {
            Externs.GADUDestroyPictureInPictureAd(this.PictureInPictureAdPtr);
