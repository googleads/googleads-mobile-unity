...
namespace GoogleMobileAds.iOS
{
    ...
    internal class Externs
    {
        ...
        [DllImport("__Internal")]
        internal static extern string GADUResponseInfoExtrasValue(IntPtr responseInfo, int index);
        ...
        [DllImport("__Internal")]
        internal static extern string GADUAdapterResponseInfoGetNetwork(
            IntPtr adapterResponseInfoRef);

        [DllImport("__Internal")]
        internal static extern string GADUAdapterResponseInfoGetAdSourceId(
            IntPtr adapterResponseInfoRef);

        [DllImport("__Internal")]
        internal static extern string GADUAdapterResponseInfoGetAdSourceName(
            IntPtr adapterResponseInfoRef);

        [DllImport("__Internal")]
        internal static extern string GADUAdapterResponseInfoGetAdSourceInstanceID(
            IntPtr adapterResponseInfoRef);

        [DllImport("__Internal")]
        internal static extern string GADUAdapterResponseInfoGetAdSourceInstanceName(
            IntPtr adapterResponseInfoRef);

        [DllImport("__Internal")]
        internal static extern long GADUAdapterResponseInfoGetLatency(
            IntPtr adapterResponseInfoRef);

        [DllImport("__Internal")]
        internal static extern int GADUAdapterResponseInfoGetAdUnitMappingCount(
            IntPtr adapterResponseInfoRef);

        [DllImport("__Internal")]
        internal static extern string GADUAdapterResponseInfoGetAdUnitMappingKey(
            IntPtr adapterResponseInfoRef,  int index);

        [DllImport("__Internal")]
        internal static extern string GADUAdapterResponseInfoGetAdUnitMappingValue(
            IntPtr adapterResponseInfoRef, int index);

        [DllImport("__Internal")]
        internal static extern IntPtr GADUAdapterResponseInfoGetAdError(
            IntPtr adapterResponseInfoRef);
