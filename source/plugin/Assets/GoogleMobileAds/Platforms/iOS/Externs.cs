...
namespace GoogleMobileAds.iOS
{
    ...
    internal class Externs
    {
        ...
        [DllImport("__Internal")]
        internal static extern bool GADURewardedAdIsPreloadedAdAvailable(string adUnitID);

        [DllImport("__Internal")]
        internal static extern void GADURewardedAdPreloadedAdWithAdUnitID(IntPtr rewardedAd, string adUnitID);
