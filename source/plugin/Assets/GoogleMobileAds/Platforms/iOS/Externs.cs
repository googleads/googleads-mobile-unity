...
namespace GoogleMobileAds.iOS
{
    ...
    internal class Externs
    {
      ...
      internal static extern void GADUPreloadWithCallback(
          IntPtr mobileAdsClient, IntPtr[] configurations, int configurationsCount,
      ...
      [DllImport("__Internal")]
      internal static extern void GADUSetMediationExtras(IntPtr request,
      ...
      [DllImport("__Internal")]
      internal static extern void GADUSetPlacementID(IntPtr request, long placementID);
      ...
      [DllImport("__Internal")]
      internal static extern string GADUGetPreloadConfigurationAdUnitID(
          IntPtr preloadConfiguration);

      [DllImport("__Internal")]
      internal static extern void GADUSetPreloadConfigurationAdUnitID(IntPtr preloadConfiguration,
                                                                      string adUnitId);
      ...
      [DllImport("__Internal")]
      internal static extern void GADUSetPreloadConfigurationAdFormat(IntPtr preloadConfiguration,
                                                                      int adFormat);

      [DllImport("__Internal")]
      internal static extern void GADUSetPreloadConfigurationAdRequest(IntPtr preloadConfiguration,
                                                                       IntPtr adRequest);

      [DllImport("__Internal")]
      internal static extern uint GADUGetPreloadConfigurationBufferSize(
          IntPtr preloadConfiguration);

      [DllImport("__Internal")]
      internal static extern void GADUSetPreloadConfigurationBufferSize(IntPtr preloadConfiguration,
                                                                        uint bufferSize);
      ...
      [DllImport("__Internal")]
      internal static extern void GADUSetPreloadConfigurationV2AdUnitID(IntPtr preloadConfiguration,
                                                                        string adUnitId);
      ...
      internal static extern void GADUSetRequestConfigurationTestDeviceIdentifiers(
          string[] testDeviceIDs, int testDeviceIDLength);
...
#region AppOpenAd externs
      ...
      [DllImport("__Internal")]
      internal static extern void GADULoadAppOpenAdWithAdUnitID(IntPtr appOpenAd, string adUnitID,
                                                                IntPtr request);
      ...
      internal static extern void GADUSetAppOpenAdCallbacks(
          ...
          AppOpenAdClient.GADUAppOpenAdDidRecordClickCallback adDidRecordClickCallback);
...
#region PictureInPictureAd externs
      ...
      [DllImport("__Internal")]
      internal static extern void GADUDestroyPictureInPictureAd(IntPtr pipAd);
...
#region AppOpenAdPreloader externs
      ...
      [DllImport("__Internal")]
      internal static extern IntPtr GADUCreateAppOpenAdPreloader(
          ...
          AppOpenAdPreloaderClient
              .GADUAdFailedToPreloadForPreloadIdCallback adFailedToPreloadCallback,
          AppOpenAdPreloaderClient.GADUAdsExhaustedForPreloadIdCallback adsExhaustedCallback);

      [DllImport("__Internal")]
      internal static extern bool GADUAppOpenAdPreloaderPreload(IntPtr appOpenAdPreloader,
                                                                string preloadId,
                                                                IntPtr preloadConfiguration);

      [DllImport("__Internal")]
      internal static extern bool GADUAppOpenAdPreloaderIsAdAvailable(IntPtr appOpenAdPreloader,
                                                                      string preloadId);

      [DllImport("__Internal")]
      internal static extern IntPtr GADUAppOpenAdPreloaderDequeueAd(IntPtr appOpenAdPreloader,
                                                                    string preloadId,
      ...
      [DllImport("__Internal")]
      internal static extern void GADUAppOpenAdPreloaderDestroy(IntPtr appOpenAdPreloader,
                                                                string preloadId);

      [DllImport("__Internal")]
      internal static extern void GADUAppOpenAdPreloaderDestroyAll(IntPtr appOpenAdPreloader);
...
#region RewardedAdPreloader externs
      ...
      [DllImport("__Internal")]
      internal static extern IntPtr GADURewardedAdPreloaderDequeueAd(IntPtr rewardedAdPreloader,
                                                                     string preloadId,
                                                                     IntPtr appOpenAdClientPtr);
...
#region InterstitialAdPreloader externs
      ...
      internal static extern IntPtr GADUCreateInterstitialAdPreloader(
          ...
          InterstitialAdPreloaderClient
              .GADUAdFailedToPreloadForPreloadIdCallback adFailedToPreloadCallback,
          InterstitialAdPreloaderClient.GADUAdsExhaustedForPreloadIdCallback adsExhaustedCallback);

      [DllImport("__Internal")]
      internal static extern bool GADUInterstitialAdPreloaderPreload(IntPtr interstitialAdPreloader,
                                                                     string preloadId,
                                                                     IntPtr preloadConfiguration);
      ...
      [DllImport("__Internal")]
      internal static extern bool GADUInterstitialAdPreloaderDestroy(IntPtr interstitialAdPreloader,
                                                                     string preloadId);
...
#region
      [DllImport("__Internal")]
      internal static extern IntPtr GAMUCreateBannerView(IntPtr bannerClient, string adUnitId,
                                                         int width, int height, int adPosition);

      [DllImport("__Internal")]
      internal static extern IntPtr GAMUCreateBannerViewWithCustomPosition(IntPtr bannerClient,
                                                                           string adUnitId,
                                                                           int width, int height,
                                                                           int x, int y);

      [DllImport("__Internal")]
      internal static extern IntPtr GAMUCreateAnchoredAdaptiveBannerView(IntPtr bannerClient,
                                                                         string adUnitId, int width,
                                                                         int orientation,
                                                                         int adPosition);
      ...
      [DllImport("__Internal")]
      internal static extern void GAMUBannerViewSetValidAdSizes(IntPtr bannerView,
                                                                int[] validAdSizesArray,
                                                                int validAdSizesLength);
...
#region Interstitial externs
      ...
      internal static extern void GADUSetInterstitialCallbacks(
          ...
          InterstitialClient.GADUInterstitialAdDidRecordClickCallback adDidRecordClickCallback,
...
#region AdManager Interstitial externs
      ...
      internal static extern void GAMUSetInterstitialCallbacks(
          ...
          AdManagerInterstitialClient.GADUInterstitialAdFailedToLoadCallback adFailedToLoadCallback,
...
#region RewardedAd externs
      ...
      internal static extern void GADUSetRewardedAdCallbacks(
          ...
          RewardedAdClient.GADURewardedAdDidRecordClickCallback adDidRecordClickCallback,
