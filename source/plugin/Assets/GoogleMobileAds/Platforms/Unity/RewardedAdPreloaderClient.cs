...
namespace GoogleMobileAds.Unity
{
    public class RewardedAdPreloaderClient : IRewardedAdPreloaderClient
    {
        ...
        private Dictionary<string, Queue<RewardedAdClient>> _bufferedAds =
            new Dictionary<string, Queue<RewardedAdClient>>();
        ...
        {
            Queue<RewardedAdClient> currentQueue;
        ...
        public IRewardedAdClient DequeueAd(string preloadId)
        {
            ...
            {
                RewardedAdClient adClient = queue.Dequeue();
