...
{
    internal class NextGenFullScreenContentErrorClient : IAdErrorClient
    {
        AndroidJavaObject _error;

        public NextGenFullScreenContentErrorClient(AndroidJavaObject error)
        {
            _error = error;
        }
        ...
        {
          return new NextGenMediationAdErrorClient(
