...
namespace GoogleMobileAds.Android {
  public class NextGenRewardedAdPreloaderClient : AndroidJavaProxy, IRewardedAdPreloaderClient {
    ...
    public NextGenRewardedAdPreloaderClient() : base(NextGenUtils.UnityPreloadCallbackClassName) {
      ...
      _unityRewardedAdPreloader =
          new AndroidJavaObject(NextGenUtils.UnityRewardedAdPreloaderClassName, activity, this);
    }
    ...
    public bool Preload(string preloadId, PreloadConfiguration preloadConfiguration,
      ...
      return _unityRewardedAdPreloader.Call<bool>(
    ...
    public IRewardedAdClient DequeueAd(string preloadId) {
      var rewardedAdClient = new NextGenRewardedAdClient();
      var unityRewardedAd =
          _unityRewardedAdPreloader.Call<AndroidJavaObject>("pollAd", preloadId, rewardedAdClient);
