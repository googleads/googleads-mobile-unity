...
{
    internal class NextGenLoadAdErrorClient : ILoadAdErrorClient
    {
        AndroidJavaObject _loadAdError;

        public NextGenLoadAdErrorClient(AndroidJavaObject loadAdError)
        {
        ...
        public int GetCode()
        {
            using (AndroidJavaObject codeEnum = _loadAdError.Call<AndroidJavaObject>("getCode"))
            {
                return codeEnum.Call<int>("getValue");
            }
        }
