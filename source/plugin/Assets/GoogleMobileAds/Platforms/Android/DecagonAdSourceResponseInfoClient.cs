...
{
    internal class DecagonAdSourceResponseInfoClient : IAdapterResponseInfoClient
    {
        private AndroidJavaObject _adapterResponseInfo;

        public DecagonAdSourceResponseInfoClient(AndroidJavaObject adapterResponseInfo)
        {
        ...
        public string AdSourceId
        {
            get
            {
                return _adapterResponseInfo == null
                        ? string.Empty
                        : _adapterResponseInfo.Call<string>("getId");
            }
        }
        ...
        public string AdSourceName
        {
            get
            {
                return _adapterResponseInfo == null
                        ? string.Empty
                        : _adapterResponseInfo.Call<string>("getName");
            }
        }
        ...
        public string AdSourceInstanceId
        {
            get
            {
                return _adapterResponseInfo == null
                        ? string.Empty
                        : _adapterResponseInfo.Call<string>("getInstanceId");
            }
        }
        ...
        public string AdSourceInstanceName
        {
            get
            {
                return _adapterResponseInfo == null
                        ? string.Empty
                        : _adapterResponseInfo.Call<string>("getInstanceName");
            }
        }
        ...
        public IAdErrorClient AdError
        {
            get
            {
                ...
                return androidError == null ? null
                                            : new DecagonMediationAdErrorClient(androidError);
            }
        }
