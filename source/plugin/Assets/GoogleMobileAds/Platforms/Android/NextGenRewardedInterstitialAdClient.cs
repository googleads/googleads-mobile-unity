                                                        ...
                                                        IRewardedInterstitialAdClient
    {
            ...
            : base(NextGenUtils.UnityRewardedInterstitialAdCallbackClassName)
        {
            ...
            _androidRewardedInterstitialAd = new AndroidJavaObject(
                NextGenUtils.UnityRewardedInterstitialAdClassName, activity, this);
        }
            ...
            ServerSideVerificationOptions serverSideVerificationOptions)
        {
            ...
            _androidRewardedInterstitialAd.Call("setServerSideVerificationOptions",
        ...
        {
            return this._androidRewardedInterstitialAd.Call<string>("getAdUnitId");
        }

        // Ad Preloading v1 will not be supported in Next Gen SDK.
