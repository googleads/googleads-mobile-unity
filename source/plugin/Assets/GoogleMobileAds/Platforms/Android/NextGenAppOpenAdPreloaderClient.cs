...
namespace GoogleMobileAds.Android {
  public class NextGenAppOpenAdPreloaderClient : AndroidJavaProxy, IAppOpenAdPreloaderClient {
    ...
    public bool Preload(string preloadId, PreloadConfiguration preloadConfiguration,
      ...
      return _unityAppOpenAdPreloader.Call<bool>(
    ...
    public IAppOpenAdClient DequeueAd(string preloadId) {
      var appOpenAdClient = new NextGenAppOpenAdClient();
      var unityAppOpenAd =
          _unityAppOpenAdPreloader.Call<AndroidJavaObject>("pollAd", preloadId, appOpenAdClient);
