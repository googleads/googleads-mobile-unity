...
{
    internal class NextGenResponseInfoClient : IResponseInfoClient
    {
        private AndroidJavaObject _androidResponseInfo;

        public NextGenResponseInfoClient(AndroidJavaObject androidJavaObject)
        {
        ...
        public IAdapterResponseInfoClient GetLoadedAdapterResponseInfo()
        {
            ...
            return androidAdSourceResponseInfo == null
                    ? null
                    : new NextGenAdSourceResponseInfoClient(androidAdSourceResponseInfo);
        }
