...
namespace GoogleMobileAds.Android
{
    public class InterstitialAdPreloaderClient : AndroidJavaProxy, IInterstitialAdPreloaderClient
    {
        ...
        public IInterstitialClient GetPreloadedAd(string preloadId)
        {
        ...
        {
            var unused = _unityInterstitialPreloader.Call<bool>("destroy", preloadId);
        }
        ...
        void onAdPreloaded(string preloadId, AndroidJavaObject responseInfo)
        {
            ...
            {
                OnAdPreloaded(preloadId, new ResponseInfoClient(ResponseInfoClientType.AdLoaded, responseInfo));
            }
        }
