...
namespace GoogleMobileAds.Common
{
    public interface IInterstitialAdPreloaderClient
    {
        ...
        /// <summary>
        /// Get the Interstitial ad PreloadConfiguration associated with the given preload ID, or
        /// null if one does not exist.
        /// </summary>
        PreloadConfiguration GetConfiguration(string preloadId);

        /// <summary>
        /// Get a dictionary of all Interstitial ad PreloadConfigurations, keyed by their associated
