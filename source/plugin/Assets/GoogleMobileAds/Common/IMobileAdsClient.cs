...
namespace GoogleMobileAds.Common
{
    ...
    public interface IMobileAdsClient
    {
        ...
        /// <summary>
        /// Opens the ad inspector UI. Callback returns an e
        /// </summary>
        /// <param name="adInspectorClosedAction">
        /// Callback rasied when the UI is closed. Returns an error is something went wrong.
        /// </param>
        void OpenAdInspector(Action<IAdErrorClient> adInspectorClosedAction);
    }
}
