...
namespace GoogleMobileAds.Common
{
    ...
    public abstract class RcsClient<TReport> : MonoBehaviour where TReport : class
    {
        ...
        protected virtual int CountThreshold => 50;
        protected virtual float TimeThresholdInSeconds => 30.0f;
        ...
        private const string ProdRcsUrl =
                "https://pagead2.googlesyndication.com/pagead/ping?e=1&f=1";

        private static readonly Queue<TReport> _queue = new Queue<TReport>();
        ...
        /// </summary>
        protected void SendToRcs(string jsonPayload, int count)
        {
            Debug.Log(string.Format("Sending a batch of {0} item(s)...", count));
