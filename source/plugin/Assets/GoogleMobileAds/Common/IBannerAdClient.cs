...
namespace GoogleMobileAds.Common
{
    ...
    /// </summary>
    public interface IBannerAdClient : IBaseAd
    {
        /// <summary>
        ...
        /// <summary>
        /// Loads a IBannerView and adds it to the view hierarchy.
        /// </summary>
        void LoadBannerAd(string adUnitId, AdSize adSize, AdPosition position);

        /// <summary>
        /// Loads a IBannerView with a custom position.
        /// </summary>
        void LoadBannerAd(string adUnitId, AdSize adSize, int x, int y);
    }
}
