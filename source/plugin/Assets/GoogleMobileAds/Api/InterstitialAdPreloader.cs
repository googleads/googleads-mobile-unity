...
namespace GoogleMobileAds.Api
{
    public static class InterstitialAdPreloader
    {
        private static readonly IInterstitialAdPreloaderClient _client =
            MobileAds.GetClientFactory().BuildInterstitialAdPreloaderClient();
        ...
        {
            Action<string, IResponseInfoClient> onAdPreloadedAction = (preloadIdOnAdPreloaded, responseInfo) =>
            {
            ...
            Action<string, IAdErrorClient> onAdFailedToPreloadAction = (preloadIdOnAdFailedToPreload, error) =>
            {
                MobileAds.RaiseAction(() =>
                {
            ...
            return _client.Preload(preloadId, preloadConfiguration, onAdPreloadedAction, onAdFailedToPreloadAction, onAdsExhaustedAction);
        }
        ...
        /// </remarks>
        public static InterstitialAd DequeueAd(string preloadId)
        {
