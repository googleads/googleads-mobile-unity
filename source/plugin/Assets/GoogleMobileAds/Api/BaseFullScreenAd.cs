...
namespace GoogleMobileAds
{
    ...
    public class BaseFullScreenAd : BaseAd
    {
        ...
        protected void Init(IBaseFullScreenAd client)
        {
            base.Init(client);
            client.OnAdFullScreenContentOpened += OnAdFullScreenContentOpened;
            client.OnAdFullScreenContentClosed += OnAdFullScreenContentClosed;
