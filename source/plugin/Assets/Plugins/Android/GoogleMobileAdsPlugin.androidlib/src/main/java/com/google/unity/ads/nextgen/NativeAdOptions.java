...
public class NativeAdOptions {
  ...
  private NativeAd.NativeMediaAspectRatio mediaAspectRatio =
      NativeAd.NativeMediaAspectRatio.UNKNOWN;
  private AdChoicesPlacement adChoicesPlacement = AdChoicesPlacement.TOP_RIGHT;
  private VideoOptions videoOptions;

  public NativeAdOptions(int mediaAspectRatio, int adChoicesPlacement) {
