...
public class UnityPictureInPictureAd {
   ...
   *
   * @param request The native {@link PictureInPictureAdRequest} object.
   */
  public void load(final PictureInPictureAdRequest request) {
    try {
      adWrapper.load(
          request,
   ...
   *
   * @param positionOrdinal 0=DEFAULT, 1=BOTTOM_RIGHT, 2=BOTTOM_LEFT, 3=TOP_LEFT, 4=TOP_RIGHT.
   */
  ...
  public int getAdPosition() {
    ...
    switch (position) {
      ...
      case TOP_RIGHT:
        return 4;
      case DEFAULT:
      default: // Guard against SDK version skew.
        return 0;
    }
  }
