...
public class UnityNativeTemplateAdNextgen {
  ...
  private TemplateViewNextgen templateView;
  ...
  private UnityNativeTemplateAdCallbackNextgen callback;

  public UnityNativeTemplateAdNextgen(
      Activity activity, UnityNativeTemplateAdCallbackNextgen callback) {
  ...
  /** Short-circuit constructor for preloaded ads. */
  public UnityNativeTemplateAdNextgen(
      Activity activity, UnityNativeTemplateAdCallbackNextgen callback, NativeAd hydratedAd) {
    this(activity, callback);
    this.nativeAd = hydratedAd;
    wireAdEvents(this.nativeAd);
  }
    ...
    activity.runOnUiThread(
        new Runnable() {
          ...
          public void run() {
            ...
            if (options != null) {
              // Convert MediaAspectRatio
              NativeAd.NativeMediaAspectRatio mediaEnum = NativeAd.NativeMediaAspectRatio.UNKNOWN;
              switch (options.getMediaAspectRatio()) {
                case 1:
                  mediaEnum = NativeAd.NativeMediaAspectRatio.ANY;
                  break;
                case 2:
                  mediaEnum = NativeAd.NativeMediaAspectRatio.LANDSCAPE;
                  break;
                case 3:
                  mediaEnum = NativeAd.NativeMediaAspectRatio.PORTRAIT;
                  break;
                case 4:
                  mediaEnum = NativeAd.NativeMediaAspectRatio.SQUARE;
                  break;
                default:
                  mediaEnum = NativeAd.NativeMediaAspectRatio.UNKNOWN;
                  break;
              }
              builder.setMediaAspectRatio(mediaEnum);

              // Convert AdChoicesPlacement
              com.google.android.libraries.ads.mobile.sdk.common.AdChoicesPlacement placementEnum =
                  com.google.android.libraries.ads.mobile.sdk.common.AdChoicesPlacement.TOP_RIGHT;
              switch (options.getAdChoicesPlacement()) {
                case 0:
                  placementEnum =
              ...
              builder.setAdChoicesPlacement(placementEnum);
  ...
  private void wireAdEvents(NativeAd ad) {
    if (ad == null) {
      return;
    }
  ...
  public void renderDefaultSizeAtPosition(
    ...
    activity.runOnUiThread(
        new Runnable() {
          @Override
          public void run() {
            int layoutId = R.layout.nextgen_medium_template_view_layout;
            if (templateStyle.getTemplateType() == UnityNativeTemplateType.SMALL) {
              layoutId = R.layout.nextgen_small_template_view_layout;
            }

            LayoutInflater layoutInflater = LayoutInflater.from(activity);
            templateView = (TemplateViewNextgen) layoutInflater.inflate(layoutId, null);
