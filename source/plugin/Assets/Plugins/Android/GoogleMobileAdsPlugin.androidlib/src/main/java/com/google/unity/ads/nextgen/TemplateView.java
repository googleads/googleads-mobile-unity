...
public final class TemplateView extends FrameLayout {
  ...
  public void setNativeAd(NativeAd nativeAd) {
    ...
    // Next-Gen registers NativeAd and MediaView together instead of setMediaView / setNativeAd.
    // We register at the end of setNativeAd, after all asset views are set, per Next-Gen SDK best
    // practices.
