...
/** Forked TemplateView for Nextgen SDK (Decagon). */
public final class TemplateViewNextgen extends FrameLayout {

  private static final String TAG = TemplateViewNextgen.class.getSimpleName();
  ...
  public TemplateViewNextgen(Context context) {
    super(context);
  }

  public TemplateViewNextgen(Context context, @Nullable AttributeSet attrs) {
    super(context, attrs);
    initView(context, attrs);
  }

  public TemplateViewNextgen(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    super(context, attrs, defStyleAttr);
    initView(context, attrs);
  }

  public TemplateViewNextgen(
  ...
  private void initView(Context context, @Nullable AttributeSet attributeSet) {
    ...
    int templateViewResource = R.layout.nextgen_medium_template_view;
    try {
  ...
  public void setNativeAd(NativeAd nativeAd) {
    ...
    com.google.android.libraries.ads.mobile.sdk.common.Image icon = nativeAd.getIcon();
    ...
    // Decagon registers NativeAd and MediaView together instead of setMediaView / setNativeAd.
    // We register at the end of setNativeAd, after all asset views are set, per Decagon best
    // practices.
  ...
  public String getTemplateTypeName() {
    if (templateType == R.layout.nextgen_medium_template_view) {
      return MEDIUM_TEMPLATE;
    } else if (templateType == R.layout.nextgen_small_template_view) {
