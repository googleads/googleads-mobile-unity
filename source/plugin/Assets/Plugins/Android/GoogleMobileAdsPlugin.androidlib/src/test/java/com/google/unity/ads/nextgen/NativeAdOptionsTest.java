...
public final class NativeAdOptionsTest {
  ...
  @Before
  public void setUp() {
    nativeAdOptions = new NativeAdOptions();
  }
  ...
  public void testConstructor_defaultValues() {
    ...
    assertThat(nativeAdOptions.getVideoOptions()).isNull();
  }
