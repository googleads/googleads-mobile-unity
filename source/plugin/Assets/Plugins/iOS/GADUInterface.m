...
void GADUSetRequestConfiguration(GADUTypeRequestConfigurationRef requestConfiguration) {
  ...
  [GADMobileAds.sharedInstance.requestConfiguration
      tagForUnderAgeOfConsent:internalRequestConfiguration.tagForUnderAgeOfConsent];
  [GADMobileAds.sharedInstance.requestConfiguration
      tagForChildDirectedTreatment:internalRequestConfiguration.tagForChildDirectedTreatment];
}
...
void GADUSetRequestConfigurationTagForUnderAgeOfConsent(
    GADUTypeRequestConfigurationRef requestConfiguration, BOOL tagForUnderAgeOfConsent) {
  GADURequestConfiguration *internalRequestConfiguration =
      (__bridge GADURequestConfiguration *)requestConfiguration;
...
void GADUSetRequestConfigurationTagForChildDirectedTreatment(
    GADUTypeRequestConfigurationRef requestConfiguration, BOOL tagForChildDirectedTreatment) {
  GADURequestConfiguration *internalRequestConfiguration =
      (__bridge GADURequestConfiguration *)requestConfiguration;
...
const BOOL GADUGetRequestConfigurationTagForUnderAgeOfConsent(
...
const BOOL GADUGetRequestConfigurationtagTagForChildDirectedTreatment(
    GADUTypeRequestConfigurationRef requestConfiguration) {
  GADURequestConfiguration *internalRequestConfiguration =
      (__bridge GADURequestConfiguration *)requestConfiguration;
