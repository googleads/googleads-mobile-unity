...
Version 9.2.0
**************
- Updated GoogleMobileAds Android SDK to 23.1.0.
- Updated GoogleMobileAds iOS SDK to 11.5.0.
- Updated External Dependency Manager for Unity to 1.2.181.
- Added the AndroidJNI dependency to the UPM package.

Built and tested with:
- Google Mobile Ads Android SDK 23.1.0
- Google Mobile Ads iOS SDK 11.5.0
